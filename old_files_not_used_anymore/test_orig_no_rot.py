...
def im_detect_heatmap(sess, net, im, boxes=None):
    ...
    cls_score, cls_prob, bbox_pred, rois, rpn_cls_prob = sess.run([net.get_output('cls_score'), net.get_output('cls_prob'), net.get_output('bbox_pred'),net.get_output('rois'), net.get_output('rpn_cls_score')], feed_dict=feed_dict)
